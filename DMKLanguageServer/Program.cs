...
public static class Program {
    private class DMKLocale : IDMKLocaleProvider {
    ...
    public static void Main(string[] args) {
        ...
        //Since assemblies are dynamically loaded, we need to pre-load the DMK assemblies
        // so they can be picked up by reflection
        foreach (var asm in 
